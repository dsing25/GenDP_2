...
| 25 | fix-required (m25, scatter_wb) | pass | fix-required (m25, scatter_wb) | fix-required (m25, scatter_wb) | pass | fix-required (m25, scatter_wb) | waive:bulk-copy-only (m25, scatter_wb) | fix-required (m25, scatter_wb) | pass | waive:no-minmax (m25, scatter_wb) | pass | pass |
...
| 29 | fix-required (m29, dedup_split_load) | pass | fix-required (m29, dedup_split_load) | fix-required (m29, dedup_split_load) | pass | waive:no-spm-read (m29, dedup_split_load) | waive:bulk-copy-only (m29, dedup_split_load) | fix-required (m29, dedup_split_load) | pass | waive:no-minmax (m29, dedup_split_load) | fix-required (m29, dedup_split_load) | pass |
| 30 | fix-required (m30, dedup_reload) | pass | fix-required (m30, dedup_reload) | fix-required (m30, dedup_reload) | pass | fix-required (m30, dedup_reload) | waive:bulk-copy-only (m30, dedup_reload) | fix-required (m30, dedup_reload) | fix-required (m30, dedup_reload) | waive:no-minmax (m30, dedup_reload) | pass | pass |
...
| 33 | fix-required (m33, merge_reload) | pass | fix-required (m33, merge_reload) | fix-required (m33, merge_reload) | pass | fix-required (m33, merge_reload) | waive:bulk-copy-only (m33, merge_reload) | fix-required (m33, merge_reload) | fix-required (m33, merge_reload) | waive:no-minmax (m33, merge_reload) | pass | pass |
...
| 35 | fix-required (m35, merge_wb) | pass | fix-required (m35, merge_wb) | fix-required (m35, merge_wb) | pass | fix-required (m35, merge_wb) | waive:bulk-copy-only (m35, merge_wb) | fix-required (m35, merge_wb) | pass | waive:no-minmax (m35, merge_wb) | pass | pass |
| 36 | fix-required (m36, diag_finalize) | pass | fix-required (m36, diag_finalize) | fix-required (m36, diag_finalize) | pass | waive:no-spm-read (m36, diag_finalize) | fix-required (m36, diag_finalize) | fix-required (m36, diag_finalize) | waive:no-bulk-transfer (m36, diag_finalize) | waive:no-minmax (m36, diag_finalize) | pass | pass |
