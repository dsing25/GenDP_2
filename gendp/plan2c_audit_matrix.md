...
| 28 | fix-preferred (m28, diag_split_load) | fix-preferred (m28, diag_split_load) | fix-preferred (m28 R3 residual: a_sp/b_sp migrated to s1c[40..49] Round 16; a0s/a1s/b0s/b1s/a_srcs/b_srcs tile arrays still locals; bs_lo/bs_hi/bs_target migrated to s1c[0..8] Round 12) | pass (m28 R4/R9 label/goto for while + per-p update branches) | pass | waive:no-spm-read (m28, diag_split_load) | pass (m28 R7 waitLSQ+NOP) | fix-preferred (m28, diag_split_load) | pass | waive:no-minmax (m28, diag_split_load) | pass | pass |
