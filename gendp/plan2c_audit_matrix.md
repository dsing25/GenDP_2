...
| 20 | fix-preferred (m20, fin0_load_batch) | fix-preferred (m20, fin0_load_batch) | done (m20 R3 cursor/total_fin0/pe_rr locals removed; pe_rr in gr[2]) | done (m20 R4 arc-loop label/goto) | pass | pass | done (m20 R7 S2+HA) | fix-preferred (m20, fin0_load_batch) | pass | waive:no-minmax (m20, fin0_load_batch) | fix-preferred (m20, fin0_load_batch) | pass |
...
| 28 | fix-preferred (m28, diag_split_load) | fix-preferred (m28, diag_split_load) | done (m28 R3 b_val/a_val captures staged via gr[3]) | done (m28 R4 label/goto) | pass | waive:no-spm-read (m28, diag_split_load) | done (m28 R7 waitLSQ+NOP) | fix-preferred (m28, diag_split_load) | pass | waive:no-minmax (m28, diag_split_load) | pass | pass |
...
| 37 | fix-preferred (m37, intv_split_load) | fix-preferred (m37, intv_split_load) | done (m37 R3 bv/av captures staged via gr[3]) | done (m37 R4 label/goto) | pass | waive:no-spm-read (m37, intv_split_load) | done (m37 R7 waitLSQ+NOP) | fix-preferred (m37, intv_split_load) | done (m37 R9 chunk-outer) | waive:no-minmax (m37, intv_split_load) | pass | pass |
| 38 | fix-preferred (m38, intv_finalize) | pass | done (m38 R3 vd_b0/b1/b2 pivots staged via main_gr[3]) | done (m38 R4 label/goto) | pass | waive:no-spm-read (m38, intv_finalize) | done (m38 R7 waitLSQ+NOP) | done (m38 R8 s1c stage) | waive:no-bulk-transfer (m38, intv_finalize) | waive:no-minmax (m38, intv_finalize) | pass | pass |
