...
| 18 | fix-preferred (m18, fin0_writeback) | fix-preferred (m18, fin0_writeback) | pass | fix-preferred (m18, fin0_writeback) | pass | done (m18 R6 phase1) | waive:no-mm-s2-load (m18, fin0_writeback) | pass | waive:queue-writeback-pattern (m18, fin0_writeback) | waive:no-minmax (m18, fin0_writeback) | pass | pass |
| 19 | pass | done (m19 R2 by gap) | pass | fix-preferred (m19, prefix_sum) | pass | done (m19 R6) | waive:no-mm-s2-load (m19, prefix_sum) | done (m19 R8) | waive:metadata-prefix-only (m19, prefix_sum) | waive:no-minmax (m19, prefix_sum) | pass | pass |
| 20 | done (m20 R1 F0B_ASSIGN macro inlined at both sites; no helper) | fix-preferred (m20, fin0_load_batch) | done (m20 R3 cursor/total_fin0/pe_rr locals removed; pe_rr in gr[2]) | done (m20 R4 arc-loop label/goto) | pass | pass | done (m20 R7 S2+HA) | fix-preferred (m20, fin0_load_batch) | pass | waive:no-minmax (m20, fin0_load_batch) | done (m20 R11 F0B_ASSIGN macro deleted; no helper macro remains) | pass |
...
| 25 | fix-preferred (m25, scatter_wb) | pass | fix-preferred (m25, scatter_wb) | fix-preferred (m25, scatter_wb) | pass | done (m25 R6) | waive:bulk-copy-only (m25, scatter_wb) | done (m25 R8) | pass | waive:no-minmax (m25, scatter_wb) | pass | pass |
| 28 | fix-preferred (m28, diag_split_load) | fix-preferred (m28, diag_split_load) | fix-preferred (m28 R3 residual: bs_lo/bs_hi/bs_target/a_sp/b_sp/a0s/a1s/b0s/b1s/a_srcs/b_srcs arrays carry cross-line state; compare captures done) | done (m28 R4 label/goto while; if-blocks inside binary-search are data-dependent — fix-preferred) | pass | waive:no-spm-read (m28, diag_split_load) | done (m28 R7 waitLSQ+NOP) | fix-preferred (m28, diag_split_load) | pass | waive:no-minmax (m28, diag_split_load) | pass | pass |
| 29 | fix-preferred (m29, dedup_split_load) | pass | fix-preferred (m29, dedup_split_load) | fix-preferred (m29, dedup_split_load) | pass | waive:no-spm-read (m29, dedup_split_load) | waive:bulk-copy-only (m29, dedup_split_load) | done (m29 R8 natural-gap) | pass | waive:no-minmax (m29, dedup_split_load) | fix-preferred (m29, dedup_split_load) | pass |
| 30 | fix-preferred (m30, dedup_reload) | pass | fix-preferred (m30, dedup_reload) | fix-preferred (m30, dedup_reload) | pass | done (m30 R6) | waive:bulk-copy-only (m30, dedup_reload) | done (m30 R8) | done (m30 R9 chunk-outer) | waive:no-minmax (m30, dedup_reload) | pass | pass |
| 31 | fix-preferred (m31, dedup_wb) | done (m31 R2 chain) | fix-preferred (m31 R3 nds/d_curs/nis/i_curs local arrays — reviewer P2) | fix-preferred (m31, dedup_wb) | pass | pass | waive:no-mm-s2-load (m31, dedup_wb) | done (m31 R8 chain) | pass | waive:no-minmax (m31, dedup_wb) | fix-preferred (m31 R11 pre-compute arrays — reviewer P2) | pass |
| 32 | fix-preferred (m32, dedup_finalize) | pass | fix-preferred (m32, dedup_finalize) | fix-preferred (m32, dedup_finalize) | pass | waive:no-spm-read (m32, dedup_finalize) | done (m32 R7) | done (m32 R8) | pass | waive:no-minmax (m32, dedup_finalize) | pass | pass |
| 33 | fix-preferred (m33, merge_reload) | pass | fix-preferred (m33, merge_reload) | fix-preferred (m33, merge_reload) | pass | done (m33 R6) | waive:bulk-copy-only (m33, merge_reload) | done (m33 R8) | done (m33 R9 chunk-outer) | waive:no-minmax (m33, merge_reload) | pass | pass |
...
| 35 | fix-preferred (m35, merge_wb) | pass | fix-preferred (m35, merge_wb) | fix-preferred (m35, merge_wb) | pass | done (m35 R6) | waive:bulk-copy-only (m35, merge_wb) | done (m35 R8) | pass | waive:no-minmax (m35, merge_wb) | pass | pass |
| 36 | fix-preferred (m36, diag_finalize) | pass | fix-preferred (m36, diag_finalize) | fix-preferred (m36, diag_finalize) | pass | waive:no-spm-read (m36, diag_finalize) | done (m36 R7) | done (m36 R8) | waive:no-bulk-transfer (m36, diag_finalize) | waive:no-minmax (m36, diag_finalize) | pass | pass |
| 37 | fix-preferred (m37, intv_split_load) | fix-preferred (m37, intv_split_load) | fix-preferred (m37 R3 residual: bs_lo/bs_hi/bs_tgt/a_sp/b_sp/a0s/a1s/b0s/b1s/a_srcs/b_srcs/pts/bvd0..2 arrays; compare captures done) | done (m37 R4 label/goto while; if-blocks inside binary-search are data-dependent — fix-preferred) | pass | waive:no-spm-read (m37, intv_split_load) | done (m37 R7 waitLSQ+NOP) | fix-preferred (m37, intv_split_load) | done (m37 R9 chunk-outer) | waive:no-minmax (m37, intv_split_load) | pass | pass |
| 38 | fix-preferred (m38, intv_finalize) | pass | fix-preferred (m38 R3 residual: h_lo_b0..2/h_hi_b0..2/l_lo_b0..2/l_hi_b0..2/mid C++ locals across m38_b*_top loops; vd pivot stashed done) | done (m38 R4 label/goto while; if-blocks inside binary-search are data-dependent — fix-preferred) | pass | waive:no-spm-read (m38, intv_finalize) | done (m38 R7 waitLSQ+NOP) | done (m38 R8 s1c stage) | waive:no-bulk-transfer (m38, intv_finalize) | waive:no-minmax (m38, intv_finalize) | pass | pass |
...
- **R1 (m20, fin0_load_batch)**: done (Round 9) — `F0B_ASSIGN` macro deleted; body inlined at f0b_rr and f0b_mv call sites with unique labels. Helper escape hatch eliminated.
...
- **R11 (m20, fin0_load_batch)**: done (Round 9) — `F0B_ASSIGN` helper macro deleted; no helper macro remains. Residual C++ locals inside the inlined bodies are short-lived per-iteration scratch; compiler register-allocates them. See residual R3 note below.
...
| Magic | R1 | R2 | R3 | R4 | R5 | R6 | R7 | R8 | R9 | R10 | R11 | R12 |
|-------|----|----|----|----|----|----|----|----|----|-----|-----|------|
| 19 | fix-preferred (m19, main_loop) | pass | fix-preferred (m19, main_loop) | fix-preferred (m19, hash_probe) | pass | done (m19 R6 diag+arcmeta) | waive:no-mm-s2-load (m19, main_loop) | waive:no-s1c-load (m19, main_loop) | fix-preferred (m19, fin0_stream) | pass | fix-preferred (m19, mvi2_ld helper) | defer:rule12-pe-compute |
