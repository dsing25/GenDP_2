...
| 28 | fix-preferred (m28, diag_split_load) | fix-preferred (m28, diag_split_load) | fix-preferred (m28 R3 residual: a_sp/b_sp/a0s/a1s/b0s/b1s/a_srcs/b_srcs still locals; bs_lo/bs_hi/bs_target migrated to s1c[0..8] Round 12) | done (m28 R4/R9 label/goto for while + per-p update branches) | pass | waive:no-spm-read (m28, diag_split_load) | done (m28 R7 waitLSQ+NOP) | fix-preferred (m28, diag_split_load) | pass | waive:no-minmax (m28, diag_split_load) | pass | pass |
...
| 37 | fix-preferred (m37, intv_split_load) | fix-preferred (m37, intv_split_load) | fix-preferred (m37 R3 residual: a_sp/b_sp/a0s/a1s/b0s/b1s/a_srcs/b_srcs/pts/bvd0..2 still locals; bs_lo/bs_hi/bs_tgt migrated to s1c[0..8] Round 12) | done (m37 R4/R9 label/goto for while + per-p update branches) | pass | waive:no-spm-read (m37, intv_split_load) | done (m37 R7 waitLSQ+NOP) | fix-preferred (m37, intv_split_load) | done (m37 R9 chunk-outer) | waive:no-minmax (m37, intv_split_load) | pass | pass |
| 38 | fix-preferred (m38, intv_finalize) | pass | fix-preferred (m38 R3 residual: bs state migrated to s1c[163..174] Round 11 + intv_n re-read Round 12 closed; merge_skipped/intv_n/ib/best_hi/best_lo/hp/lp still C++ locals in finalize head + merged-boundary path) | done (m38 R4/R9 label/goto for while + update branches) | pass | waive:no-spm-read (m38, intv_finalize) | done (m38 R7 waitLSQ+NOP) | done (m38 R8 s1c stage) | waive:no-bulk-transfer (m38, intv_finalize) | waive:no-minmax (m38, intv_finalize) | pass | pass |
