...
| 28 | fix-required (m28, diag_split_load) | fix-required (m28, diag_split_load) | fix-required (m28, diag_split_load) | fix-required (m28, diag_split_load) | pass | waive:no-spm-read (m28, diag_split_load) | fix-required (m28, diag_split_load) | fix-required (m28, diag_split_load) | pass | waive:no-minmax (m28, diag_split_load) | pass | pass |
...
| 30 | fix-preferred (m30, dedup_reload) | pass | fix-preferred (m30, dedup_reload) | fix-preferred (m30, dedup_reload) | pass | done (m30 R6) | waive:bulk-copy-only (m30, dedup_reload) | done (m30 R8) | waive:BL-20260416-m32-gather-dep (m30, dedup_reload) | waive:no-minmax (m30, dedup_reload) | pass | pass |
| 31 | fix-required (m31, dedup_wb) | fix-required (m31, dedup_wb) | pass | fix-required (m31, dedup_wb) | pass | pass | waive:no-mm-s2-load (m31, dedup_wb) | fix-required (m31, dedup_wb) | pass | waive:no-minmax (m31, dedup_wb) | pass | pass |
| 32 | fix-required (m32, dedup_finalize) | pass | fix-required (m32, dedup_finalize) | fix-required (m32, dedup_finalize) | pass | waive:no-spm-read (m32, dedup_finalize) | fix-required (m32, dedup_finalize) | fix-required (m32, dedup_finalize) | pass | waive:no-minmax (m32, dedup_finalize) | pass | pass |
| 33 | fix-preferred (m33, merge_reload) | pass | fix-preferred (m33, merge_reload) | fix-preferred (m33, merge_reload) | pass | done (m33 R6) | waive:bulk-copy-only (m33, merge_reload) | done (m33 R8) | waive:BL-20260416-m32-gather-dep (m33, merge_reload) | waive:no-minmax (m33, merge_reload) | pass | pass |
...
| 37 | fix-required (m37, intv_split_load) | fix-required (m37, intv_split_load) | fix-required (m37, intv_split_load) | fix-required (m37, intv_split_load) | pass | waive:no-spm-read (m37, intv_split_load) | fix-required (m37, intv_split_load) | fix-required (m37, intv_split_load) | fix-required (m37, intv_split_load) | waive:no-minmax (m37, intv_split_load) | pass | pass |
| 38 | fix-required (m38, intv_finalize) | pass | fix-required (m38, intv_finalize) | fix-required (m38, intv_finalize) | pass | waive:no-spm-read (m38, intv_finalize) | fix-required (m38, intv_finalize) | fix-required (m38, intv_finalize) | waive:no-bulk-transfer (m38, intv_finalize) | waive:no-minmax (m38, intv_finalize) | pass | pass |
...
- **R1 (m20, fin0_load_batch)**: fix-required — helper-backed body and `F0B_ASSIGN` still bundle multi-op control/dataflow into single source lines.
...
- **R11 (m20, fin0_load_batch)**: fix-required — helper indirection plus `F0B_ASSIGN` still hides live state in non-architectural C++ locals.
...
| Magic | R1 | R2 | R3 | R4 | R5 | R6 | R7 | R8 | R9 | R10 | R11 | R12 |
|-------|----|----|----|----|----|----|----|----|----|-----|-----|------|
| 19 | fix-required (m19, main_loop) | pass | fix-required (m19, main_loop) | fix-required (m19, hash_probe) | pass | fix-required (m19, main_loop) | waive:no-mm-s2-load (m19, main_loop) | waive:no-s1c-load (m19, main_loop) | fix-preferred (m19, fin0_stream) | pass | fix-preferred (m19, mvi2_ld helper) | defer:rule12-pe-compute |
| 20 | fix-required (m20, count_loop) | pass | fix-required (m20, count_loop) | fix-required (m20, count_loop) | pass | fix-required (m20, count_loop) | waive:no-mm-s2-load (m20, count_loop) | waive:no-s1c-load (m20, count_loop) | fix-preferred (m20, count_loop) | pass | pass | defer:rule12-pe-compute |
| 21 | fix-required (m21, scatter_loop) | pass | fix-required (m21, scatter_loop) | fix-required (m21, scatter_loop) | pass | fix-required (m21, scatter_loop) | waive:no-mm-s2-load (m21, scatter_loop) | waive:no-s1c-load (m21, scatter_loop) | fix-preferred (m21, scatter_loop) | pass | pass | defer:rule12-pe-compute |
| 22 | fix-required (m22, emit_fast_path) | pass | fix-required (m22, entry_restore) | fix-required (m22, emit_fast_path) | pass | fix-required (m22, emit_fast_path) | waive:no-mm-s2-load (m22, emit_fast_path) | waive:no-s1c-load (m22, emit_fast_path) | waive:no-bulk-transfer (m22, merge_emit) | pass | pass | defer:rule12-pe-compute |
