...
| 38 | fix-preferred (m38, intv_finalize) | pass | done (m38 R3 all bs state in s1c[163..174]; mid in main_gr[5]; pivot in main_gr[3]) | done (m38 R4/R9 label/goto for while + update branches) | pass | waive:no-spm-read (m38, intv_finalize) | done (m38 R7 waitLSQ+NOP) | done (m38 R8 s1c stage) | waive:no-bulk-transfer (m38, intv_finalize) | waive:no-minmax (m38, intv_finalize) | pass | pass |
