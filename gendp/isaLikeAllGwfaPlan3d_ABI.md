...
| gr[2]  | m19 (unused — vd moved to reg[6] per Round 5); m20 shift (full int — Round 8 amendment aligns with in-code header pe.cpp:1419); m21 shift (full int — same Round 8 alignment, pe.cpp:1521); m22 (unused — see gr[1] note for Round 4); m23 (unused — see gr[1] note for Round 3, gr is `addr_regfile` so C++ reference aliasing infeasible) | Per-magic scratch (m20/m21 deviate to full-int shift) | Dead on each boundary | EXTENDED |
| gr[3]  | m19 (unused — k moved to reg[7] per Round 5); m20 tile_buf_off (full int — pe.cpp:1420); m21 tile_buf_off (full int — pe.cpp:1522); m22 (unused — see gr[1] note); m23 (unused — see gr[1] note)   | Per-magic SPM-offset / pair scratch                                                                            | Dead on each boundary                                                         | EXTENDED |
| gr[4]  | m19 (unused — v/d_val derived inline from vd per Round 5); m20 scratch (i*2, i+1 — pe.cpp:1421); m21 bin_spm_off (full int — pe.cpp:1523); m22 (unused — see gr[1] note); m23 (unused — see gr[1] note) | Per-magic local accumulator                                                                                  | Dead on each boundary                                                         | EXTENDED |
| gr[5]  | m19 (unused — i_val derived inline from vd+k per Round 5); m20 bin0 (≤ 15 — pe.cpp:1422); m21 scratch (i*2 / i+1 — pe.cpp:1524); m22 (unused — see gr[1] note); m23 (unused — see gr[1] note)      | Per-magic local accumulator                                                                                    | Dead on each boundary                                                         | EXTENDED |
| gr[6]  | m19 (unused — arc_idx moved to reg[5]; ow moved to reg[12]); m20 bin1 (≤ 15 — pe.cpp:1423); m21 bin (current 0..15 — pe.cpp:1525); m22 (free post Round 8 amendment); m23 (unused — see gr[1] note) | Per-magic accumulator                                                                                          | Dead on each boundary                                                         | EXTENDED |
| gr[7]  | m19 (unused — packed_vw moved to reg[11] per Round 5); m20 (unused); m21 (unused — bin_cursors moved to SPM at SORT_META+34..49 per Round 3 §3.3); m22 (unused — see gr[1] note); m23 (unused — see gr[1] note) | General scratch                                                                                                | Dead on each boundary                                                         | NEW       |
| gr[8]  | m19 (unused — w derived inline from packed_vw per Round 5); m20 (unused); m21 (unused); m22 (unused — see gr[1] note); m23 (unused — see gr[1] note)                                                | Half-reg pair / emit register                                                                                  | Dead on each boundary                                                         | NEW       |
| gr[9]  | m19 (unused — hkey moved to reg[14] per Round 5); m20 (unused); m21 (unused); m22 (unused — see gr[1] note); m23 (unused — see gr[1] note)                                                          | Full-width per-magic scalar                                                                                    | Dead on each boundary                                                         | NEW       |
...
| gr[14] | m19 (unused — n_A moved to reg[2], n_B moved to reg[3] per Round 5); m20 (unused — SORT_META offset is a constexpr immediate in lowered body); m21 (unused — same); m22 (unused); m23 (unused — see gr[2] note) | Per-magic                                                                                                       | Dead on each boundary                                                         | NEW       |
| gr[15] | m19 (unused — n_HA moved to reg[4] per Round 5); m20 (unused — bin0/bin1 in gr[5]/gr[6] full int per pe.cpp:1422-1423); m21 (unused — bin in gr[6] full int per pe.cpp:1525); m22 (free); m23 (unused — see gr[2] note) | Per-magic                                                                                                       | Dead on each boundary                                                         | NEW       |
