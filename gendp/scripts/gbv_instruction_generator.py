...
# Eq:5 , VN:6 , VP:7 , hinN:8, hinP:9, Xh:10, Xv:11, Ph:12, Mh:13, tempMh:14, tempPh:15, scoreEnd:16, temp1:17, temp2:18, temp3:19
...
def gbv_compute():
    ...
    f = open("instructions/gbv/compute_instruction.txt", "w")
