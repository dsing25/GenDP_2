...
def poa_main_instruction():
    ...
    f.write(data_movement_instruction(0, 0, 0, 0, 69, 0, 1, 0, 6, 3, bge))                                  # bge gr[6] gr[3] 59
    ...
    f.write(data_movement_instruction(0, 0, 0, 0, -68, 0, 0, 0, 0, 0, beq))                                 # beq 0 0 -68 zkn
